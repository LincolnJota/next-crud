...
export type ScheduledOperationAffectedDocument = Asset | Usuario;
...
export type UsuarioManyWhereInput = {
  ...
  /** All values greater than the given value. */
  idade_gt?: InputMaybe<Scalars['Int']>;
  /** All values greater than or equal the given value. */
  idade_gte?: InputMaybe<Scalars['Int']>;
  /** All values that are contained in given list. */
  idade_in?: InputMaybe<Array<Scalars['Int']>>;
  /** All values less than the given value. */
  idade_lt?: InputMaybe<Scalars['Int']>;
  /** All values less than or equal the given value. */
  idade_lte?: InputMaybe<Scalars['Int']>;
  /** All values that are not equal to given value. */
  idade_not?: InputMaybe<Scalars['Int']>;
  /** All values that are not contained in given list. */
  idade_not_in?: InputMaybe<Array<Scalars['Int']>>;
...
export type AtualizarUsuarioMutation = { __typename?: 'Mutation', updateUsuario?: { __typename?: 'Usuario', id: string } | null };
...
export type CreateUsuarioMutation = { __typename?: 'Mutation', createUsuario?: { __typename?: 'Usuario', id: string } | null };
...
export type DeleteUsuarioMutation = { __typename?: 'Mutation', deleteUsuario?: { __typename?: 'Usuario', id: string } | null };

export type PublicarUsuarioMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type PublicarUsuarioMutation = { __typename?: 'Mutation', publishUsuario?: { __typename?: 'Usuario', id: string } | null };

export type UpdateUsuarioMutationVariables = Exact<{
  id: Scalars['ID'];
  toUpdate: UsuarioUpdateInput;
}>;


export type UpdateUsuarioMutation = { __typename?: 'Mutation', updateUsuario?: { __typename?: 'Usuario', id: string } | null };

export type GetUsuariosQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUsuariosQuery = { __typename?: 'Query', usuarios: Array<{ __typename?: 'Usuario', id: string, nome: string, idade: number }> };


export const AtualizarUsuarioDocument = gql`
    mutation AtualizarUsuario($nome: String!, $idade: Int!, $id: ID!) {
  updateUsuario(data: {nome: $nome, idade: $idade}, where: {id: $id}) {
    id
  }
}
    `;
export type AtualizarUsuarioMutationFn = Apollo.MutationFunction<AtualizarUsuarioMutation, AtualizarUsuarioMutationVariables>;

/**
 * __useAtualizarUsuarioMutation__
 *
 * To run a mutation, you first call `useAtualizarUsuarioMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAtualizarUsuarioMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [atualizarUsuarioMutation, { data, loading, error }] = useAtualizarUsuarioMutation({
 *   variables: {
 *      nome: // value for 'nome'
 ...
 * });
 */
export function useAtualizarUsuarioMutation(baseOptions?: Apollo.MutationHookOptions<AtualizarUsuarioMutation, AtualizarUsuarioMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AtualizarUsuarioMutation, AtualizarUsuarioMutationVariables>(AtualizarUsuarioDocument, options);
      }
export type AtualizarUsuarioMutationHookResult = ReturnType<typeof useAtualizarUsuarioMutation>;
export type AtualizarUsuarioMutationResult = Apollo.MutationResult<AtualizarUsuarioMutation>;
export type AtualizarUsuarioMutationOptions = Apollo.BaseMutationOptions<AtualizarUsuarioMutation, AtualizarUsuarioMutationVariables>;
export const CreateUsuarioDocument = gql`
    mutation CreateUsuario($nome: String!, $idade: Int!) {
  createUsuario(data: {nome: $nome, idade: $idade}) {
    id
  }
}
    `;
...
export const PublicarUsuarioDocument = gql`
    mutation PublicarUsuario($id: ID!) {
  publishUsuario(where: {id: $id}, to: PUBLISHED) {
    id
  }
}
    `;
export type PublicarUsuarioMutationFn = Apollo.MutationFunction<PublicarUsuarioMutation, PublicarUsuarioMutationVariables>;

/**
 * __usePublicarUsuarioMutation__
 *
 * To run a mutation, you first call `usePublicarUsuarioMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePublicarUsuarioMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [publicarUsuarioMutation, { data, loading, error }] = usePublicarUsuarioMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function usePublicarUsuarioMutation(baseOptions?: Apollo.MutationHookOptions<PublicarUsuarioMutation, PublicarUsuarioMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PublicarUsuarioMutation, PublicarUsuarioMutationVariables>(PublicarUsuarioDocument, options);
      }
export type PublicarUsuarioMutationHookResult = ReturnType<typeof usePublicarUsuarioMutation>;
export type PublicarUsuarioMutationResult = Apollo.MutationResult<PublicarUsuarioMutation>;
export type PublicarUsuarioMutationOptions = Apollo.BaseMutationOptions<PublicarUsuarioMutation, PublicarUsuarioMutationVariables>;
export const UpdateUsuarioDocument = gql`
    mutation UpdateUsuario($id: ID!, $toUpdate: UsuarioUpdateInput!) {
  updateUsuario(data: $toUpdate, where: {id: $id}) {
    id
  }
}
    `;
